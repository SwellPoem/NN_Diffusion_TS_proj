...
# def get_dataloader_common(config, dataset_key, batch_size_key, shuffle, args=None):
#     batch_size = config['dataloader'][batch_size_key]
#     config['dataloader'][dataset_key]['params']['output_dir'] = args.save_dir
...
# def get_dataloader(config, args=None):
#     return get_dataloader_common(config, 'train_dataset', 'batch_size', True, args)

# def get_dataloader_cond(config, args=None):
#     if args.mode == 'infill':
...
#     return get_dataloader_common(config, 'test_dataset', 'sample_size', False, args)
